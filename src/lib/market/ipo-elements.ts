...
export const RULES: Array<{ el: "ไม้" | "ไฟ" | "ดิน" | "ทอง" | "น้ำ"; kw: RegExp; note: string }> = [
  ...
  { el: "ไฟ", kw: /cosmetic|beauty|skincare|makeup|เครื่องสำอาง|ความงาม|สกินแคร์|เสริมสวย|แฟชั่นโชว์|บันเทิง|화장품|뷰티/i, note: "เครื่องสำอาง/ความงาม (Source6: ความงาม เครื่องสำอาง=ไฟ)" },
  ...
  // ── ดิน: เกษตร/ปศุสัตว์/อาหารสัตว์ (ก่อน น้ำ-อาหาร — pet food = อาหารสัตว์ = ดิน) ──
  ...
  // ── น้ำ: ขนส่ง/อาหาร/เครื่องดื่ม/ค้าปลีก/โรงแรม (ก่อน เทค — food-tech = อาหาร) ──
  { el: "น้ำ", kw: /ocean|water|marine|shipping|logistics|port|travel|tourism|hotel|restaurant|beverage|food|retail|store|เครื่องดื่ม|น้ำดื่ม|เบียร์|อาหาร|ขนส่ง|โลจิสติกส์|ท่องเที่ยว|โรงแรม|รีสอร์ท|ค้าปลีก|ซูเปอร์|มาร์เก็ต|ร้านสะดวกซื้อ|식품|음료|유통|물류/i, note: "ขนส่ง/ท่องเที่ยว/อาหาร/เครื่องดื่ม/ค้าปลีก (Source6: ขนส่ง อาหาร เครื่องดื่ม=น้ำ)" },
