  ...
  return (
    <div className="print-shell">
      ...
      {maxSection >= 3 && (
        <>
          <section className="page">
            <h2 className="chap-head"><span>ภาคผนวก ก</span> เช็กลิสต์ก่อนลงทุน (16 ข้อ)</h2>
            <p className="lede">ตรวจทุกข้อก่อนซื้อทุกครั้ง — ผ่าน 16/16 ถึงเริ่ม (ข้อไหนไม่ได้ = หยุดก่อน)</p>
            {[
