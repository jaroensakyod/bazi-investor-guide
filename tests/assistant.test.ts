...
describe("assistant — LLM + tool calling (Phase 1.5)", () => {
  it("TOOL_DEFS มีครบ 11 tools", () => {
    expect(TOOL_NAMES).toEqual(["getTodayMovers", "getUpcomingIPOs", "getBaziVerdict", "getFundamentals", "getNewsImpact", "searchStocks", "generateReport", "getTodayAlmanac", "getFortuneInvest", "getAssetVerdicts", "getPortfolioAllocation"]);
  });
